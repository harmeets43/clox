...
static void endScope() {
	...
	// discard all the local by walking backwards.
...
/*
	...
	An infix parser function is even more in medias res—the left-hand operand has already been compiled and the subsequent infix operator consumed.
...
static void declareVariable() {
	// global variable are impilicitly declared
	if (current->scopeDepth == 0) return;

	Token* name = &parser.previous;
	// Detect if the variable is already declared in the scope defined.
